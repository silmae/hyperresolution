...
if __name__ == '__main__':
    ...
    # From optimization
    # value   params_d_kernel_size  params_e_filter_count    params_e_kernel_size    params_enc_layer_count    params_endmember_count    params_kernel_reduction    params_learning_rate
    # 0.018559    1    392    10    5    12    0    0.009362
