...
if __name__ == '__main__':
    ...
    # training_data = nn.TrainingData(type='DAWN_ISIS', filepath=Path('./datasets/DAWN/ISIS/m-VIR_IR_1B_1_494253260_1.cub')) # Ceres, HAMO, Occator: ON THIS ONE THE OCCATOR BRIGHT SPOTS HAVE AN ARTEFACT WHERE DATA IS MISSING!
    ...
    training_data = nn.TrainingData(type='DAWN_ISIS', filepath=Path(
        './datasets/DAWN/ISIS/m-VIR_VIS_1B_1_366641356_1.cub'))  # Vesta, HAMO, Marcia-Calpurnia-Minucia
    ...
    # nn.train(training_data, enc_params=enc_params, dec_params=dec_params, common_params=common_params, epochs=40000, prints=True, plots=True)
